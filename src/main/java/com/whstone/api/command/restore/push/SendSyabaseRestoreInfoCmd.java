 ...
 * @Date: 2018/11/14
 */
public class SendSyabaseRestoreInfoCmd extends BaseCmd {

    private static final String COMMAND_NAME = "sendSyabseRestoreInfo";
    /**
     * 恢复操作ID
     */
    ...
    public SendSyabaseRestoreInfoCmd(ApiData apiData) {
        super(apiData, ApiResponseConstants.SENDSYBASERESTOREINFORESPONSE);
