 ...
 */
public class SendSwitchProductIpWinCmd extends BaseCmd {

    private static final String COMMAND_NAME = "SendSwitchProductIp";
    ...
    public String toString() {
        return "SendSwitchProductIpWinCmd{" +
                "switchId=" + switchId +
                ", state=" + state +
                ", message='" + message + '\'' +
                ", proIp='" + proIp + '\'' +
    ...
    public SendSwitchProductIpWinCmd(ApiData apiData) {
        super(apiData, ApiResponseConstants.SENDSWITCHPRODUCTIPRESPONSE);
