 ...
 */
public class SendOracleCancelConnStandResWoLCmd extends BaseCmd {

    private static final String COMMAND_NAME = "SendOracleCancelConnStandRes";
    ...
    public String toString() {
        return "SendOracleCancelConnStandResWoLCmd{" +
                "initId=" + initId +
                ", initIds='" + initIds + '\'' +
                ", status='" + status + '\'' +
                ", message='" + message + '\'' +
    ...
    public SendOracleCancelConnStandResWoLCmd(ApiData apiData) {
        super(apiData, ApiResponseConstants.SENDORACLECANCELCONNSTANDRESRESPONSE);
