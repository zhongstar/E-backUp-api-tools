 ...
 */
public class SendDeleteVmHostServerCmd extends BaseCmd {

    private static final String COMMAND_NAME = "sendDeleteVmHostServerInfo";
    ...
    public SendDeleteVmHostServerCmd(ApiData apiData) {
        super(apiData, ApiResponseConstants.SENDDELETEVMHOSTSERVERRESPONSE);
